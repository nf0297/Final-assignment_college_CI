...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Detail_cproduk <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="decimal">Ri <?php echo form_error('ri') ?></label>
            <input type="text" class="form-control" name="ri" id="ri" placeholder="Ri" value="<?php echo $ri; ?>" />
        </div>
	    <input type="hidden" name="id_cproses" value="<?php echo $id_cproses; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('dummy') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>